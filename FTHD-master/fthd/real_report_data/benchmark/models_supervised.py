...
class ModelBase(nn.Module):
    ...
    def forward(self, x, x_norm, h0_=None, time_feature=None, times=None):
        ...
        o, d_o, f_q,sys_param_dict_mass= self.differential_equation(x, ff, time_feature, times)
        return o, h0_, d_o, f_q ,sys_param_dict_mass
...
class FTHDModel(ModelBase):
    ...
    def differential_equation(self, x, output, time_feature, times):
        ...
        ax = dxdt
        dxdt *= Ts
        return x[:,-1,:3] + dxdt, ax, [alphaf,Ffy,alphar,Fry] , sys_param_dict["Mass"]
