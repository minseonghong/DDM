...
# axs[0].plot(GTfront_force[:,0],GTfront_force[:,1],color='red',label='GT Ffy')
# axs[0].plot(Hybridfront_force[:,0],Hybridfront_force[:,1],color='blue',linestyle='-.',label='Hybrid Adam Ffy')
# axs[0].plot(DDMfront_force[:,0],DDMfront_force[:,1],color='black',linestyle='-.',label='DDM Ffy')
# axs[0].plot(DDPfront_force[:,0],DDPfront_force[:,1],color='brown',linestyle='-.',label='Hybrid dualdimer Ffy')
...
# axs[1].plot(GTrear_force[:,0],GTrear_force[:,2],color='red',label='GT Fry')
# axs[1].plot(Hybridrear_force[:,0],Hybridrear_force[:,2],color='blue',linestyle='-.',label='Hybrid Adam Fry')
# axs[1].plot(DDMrear_force[:,0],DDMrear_force[:,2],color='black',linestyle='-.',label='DDM Fry')
# axs[1].plot(DDPrear_force[:,0],DDPrear_force[:,2],color='brown',linestyle='-.',label='Hybrid dualdimer Fry')
...
axs[0].plot(GTfront_force[:,0],GTfront_force[:,1],color='red', linewidth=plot_linewidth)
axs[0].plot(Hybridfront_force[:,0],Hybridfront_force[:,1],color='blue',linestyle='--', linewidth=plot_linewidth)
axs[0].plot(DDMfront_force[:,0],DDMfront_force[:,1],color='black',linestyle='-.', linewidth=plot_linewidth)
# axs[0].plot(DDPfront_force[:,0],DDPfront_force[:,1],color='brown',linestyle=':', linewidth=plot_linewidth)

axs[0].set_xlim(0.55,0.64)
axs[0].set_ylim(0.191,0.195)
# axs[0].set_title('Zoomed Ffy force with {} percent trainset'.format(training_percent),fontsize=fontsize-3)
# axs[0].legend(loc='upper left')

axs[1].plot(GTrear_force[:,0],GTrear_force[:,2],color='red', linewidth=plot_linewidth)
axs[1].plot(Hybridrear_force[:,0],Hybridrear_force[:,2],color='blue',linestyle='--', linewidth=plot_linewidth)
axs[1].plot(DDMrear_force[:,0],DDMrear_force[:,2],color='black',linestyle='-.', linewidth=plot_linewidth)
# axs[1].plot(DDPrear_force[:,0],DDPrear_force[:,2],color='brown',linestyle=':', linewidth=plot_linewidth)

axs[1].set_xlim(0.4,0.5787)
axs[1].set_ylim(0.165,0.19)
# axs[1].set_title('Zoomed Fry force with {} percent trainset'.format(training_percent),fontsize=fontsize-3)
# axs[1].legend(loc='lower right')
...
plt.tight_layout()
saved_file = 'output/poseter_scaled_trained_force_benchmark_{}.svg'.format(training_percent)
plt.savefig(os.path.join(dir_name,saved_file),transparent=True, format='svg')

saved_file = 'output/poseter_scaled_trained_force_benchmark_{}.pdf'.format(training_percent)
